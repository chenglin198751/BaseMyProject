...
public class ZoomImageView extends AppCompatImageView {
    ...
    /**
     * Get the current {@link PhotoViewAttacher} for this com.wcl.test.view. Be wary of holding on to references
     * to this attacher, as it has a reference to this com.wcl.test.view, which, if a reference is held in the
