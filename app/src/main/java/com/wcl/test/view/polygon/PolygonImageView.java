...
package com.wcl.test.view.polygon;
...
import com.wcl.test.view.polygon.shapes.PolygonShape;
import com.wcl.test.view.polygon.shapes.PolygonShapeSpec;
import com.wcl.test.view.polygon.shapes.RegularPolygonShape;


/**
 * Construct a custom ImageView with a regular polygonal form.
 * The number of vertices determines the com.wcl.test.view.polygon form.
 * Special cases for vertex number are:
 * 0 -> Circle
 * 1 -> Regular ImageView
 * 2 -> Square
 * Use square images
 * github:https://github.com/AlbertGrobas/PolygonImageView
 *
...
public class PolygonImageView extends AppCompatImageView {
    ...
    private void init() {
        ...
        if (mPolygonShapeSpec.hasShadow()) {
            ...
            //using shadow on com.wcl.test.main paint
    ...
    /**
     * Gets incoming new canvas size and updates com.wcl.test.view.polygon form and image if needed.
     *
     * @param w    new Width
     * @param h    new Height
    ...
    private int measureHeight(int measureSpecHeight) {
        //Force do not square measure to solve bug (use com.wcl.test.base 2 better performance)
    ...
    /**
     * Draw the com.wcl.test.view.polygon form.
     *
     * @param canvas com.wcl.test.main canvas
     */
    @Override
    ...
    /**
     * Rebuild com.wcl.test.view.polygon after changes, take cares about padding, border and shadow radius.
    ...
    /**
     * Update com.wcl.test.view.polygon size with unspecified padding.
     */
    ...
    /**
     * Update com.wcl.test.view.polygon with new padding.
     *
    ...
    private void updatePolygonSize(int l, int t, int r, int b) {
        ...
        //if the size is changed we need to rebuild the com.wcl.test.view.polygon
    ...
    /**
     * Set new rotate angle and updates com.wcl.test.view.polygon form.
     *
    ...
    /**
     * Sets the new vertex number and updates com.wcl.test.view.polygon form.
     *
    ...
    /**
     * Sets new border width and com.wcl.test.update com.wcl.test.view.polygon size.
     */
    ...
    /**
     * Sets new radius for corners and updates com.wcl.test.view.
     *
