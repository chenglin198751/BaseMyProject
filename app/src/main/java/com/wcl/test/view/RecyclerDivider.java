...
public class RecyclerDivider extends RecyclerView.ItemDecoration {
    ...
    private void handleGridOffsets(
        ...
        if (includeEdge) {
            ...
            outRect.left =
                    dividerThickness - column * dividerThickness / spanCount;

            outRect.right =
                    (column + 1) * dividerThickness / spanCount;
            ...
            outRect.left =
                    column * dividerThickness / spanCount;

            outRect.right =
                    dividerThickness - (column + 1) * dividerThickness / spanCount;
    ...
    private void drawLinear(
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (includeEdge && position == 0) {
                ...
                canvas.drawRect(
                        childLeft - dividerThickness,
                        childTop - dividerThickness,
                        childRight + dividerThickness,
                        childTop,
                        paint
                );
            }
            ...
            if (includeEdge || position != itemCount - 1) {
                ...
                canvas.drawRect(
                        childLeft - (includeEdge ? dividerThickness : 0),
                        childBottom,
                        childRight + (includeEdge ? dividerThickness : 0),
                        childBottom + dividerThickness,
                        paint
                );
            }
        }
    ...
    private boolean isLastRow(
        ...
        if (remainder == 0) {
            lastRowStart = itemCount - spanCount;
        } else {
            lastRowStart = itemCount - remainder;
        }
