...
import com.wcl.test.banner.config.BannerConfig;
import com.wcl.test.banner.config.IndicatorConfig;
import com.wcl.test.banner.indicator.Indicator;
import com.wcl.test.banner.listener.OnBannerListener;
import com.wcl.test.banner.listener.OnPageChangeListener;
import com.wcl.test.banner.transformer.MZScaleInTransformer;
import com.wcl.test.banner.transformer.ScaleInTransformer;
import com.wcl.test.banner.util.BannerLifecycleObserverAdapter;
import com.wcl.test.banner.util.BannerUtils;
import com.wcl.test.banner.util.BannerLifecycleObserver;
import com.wcl.test.banner.util.ScrollSpeedManger;
