...
public class FastBlurUtil {
     ...
     */
    public static void doBlur(View view, int scale, final int radius, final OnFinishedListener<Bitmap> listener) {
     ...
     * @param radius     高斯模糊的半径，默认是4：高斯模糊计算半径，半径越大越模糊，但通常越耗时
     */
    public static void doBlur(Bitmap sentBitmap, int scale, final int radius, final OnFinishedListener<Bitmap> listener) {
