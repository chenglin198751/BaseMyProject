...
public class RoundedImageView extends AppCompatImageView {
    ...
    /**
     * Return true if this cheerly.mybaseproject.view should be oval and always set corner radii to half the height or
     * width.
     *
     ...
     *
     * @param mutate true if this cheerly.mybaseproject.view should mutate the background drawable.
     */
