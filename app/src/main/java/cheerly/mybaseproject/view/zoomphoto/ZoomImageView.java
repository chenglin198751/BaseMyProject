...
public class ZoomImageView extends WebImageView {
    ...
    /**
     * Get the current {@link PhotoViewAttacher} for this cheerly.mybaseproject.view. Be wary of holding on to references
     * to this attacher, as it has a reference to this cheerly.mybaseproject.view, which, if a reference is held in the
