...
package cheerly.mybaseproject.view.polygon;
 ...
 * The number of vertices determines the cheerly.mybaseproject.view.polygon form.
...
public class PolygonImageView extends WebImageView {
    ...
    private void init() {
        ...
        if (mPolygonShapeSpec.hasShadow()) {
            ...
            //using shadow on cheerly.mybaseproject.main paint
    ...
    /**
     * Gets incoming new canvas size and updates cheerly.mybaseproject.view.polygon form and image if needed.
     *
     * @param w    new Width
     * @param h    new Height
    ...
    private int measureHeight(int measureSpecHeight) {
        //Force do not square measure to solve bug (use cheerly.mybaseproject.base 2 better performance)
    ...
    /**
     * Draw the cheerly.mybaseproject.view.polygon form.
     *
     * @param canvas cheerly.mybaseproject.main canvas
     */
    @Override
    ...
    /**
     * Rebuild cheerly.mybaseproject.view.polygon after changes, take cares about padding, border and shadow radius.
    ...
    /**
     * Update cheerly.mybaseproject.view.polygon size with unspecified padding.
     */
    ...
    /**
     * Update cheerly.mybaseproject.view.polygon with new padding.
     *
    ...
    private void updatePolygonSize(int l, int t, int r, int b) {
        ...
        //if the size is changed we need to rebuild the cheerly.mybaseproject.view.polygon
    ...
    /**
     * Set new rotate angle and updates cheerly.mybaseproject.view.polygon form.
     *
    ...
    /**
     * Sets the new vertex number and updates cheerly.mybaseproject.view.polygon form.
     *
    ...
    /**
     * Sets new border width and cheerly.mybaseproject.update cheerly.mybaseproject.view.polygon size.
     */
    ...
    /**
     * Sets new radius for corners and updates cheerly.mybaseproject.view.
     *
