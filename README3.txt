1、激发键盘的删除事件：(As字体： consolas 17 1.0)
...
8、得到图片的宽高：
    ...
    public static int getBitmapWidth(final String path) {
...
12、WebView不要再用系统的了， 用腾讯的X5内核：
http://x5.tencent.com/tbs/product/tbs.html
...
26、RecyclerView嵌套RecyclerView时自动滚动的bug：两种解决办法：
    1、
